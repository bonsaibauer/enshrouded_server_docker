...
RUN ln -sf /usr/local/etc/enshrouded/jobs/ctl /usr/local/bin/ctl \
    && ln -sf /usr/local/etc/enshrouded/jobs/ctl /usr/local/bin/menu \
    && ln -sf /usr/local/etc/enshrouded/jobs/ctl /usr/local/bin/status \
    && ln -sf /usr/local/etc/enshrouded/jobs/ctl /usr/local/bin/start \
    && ln -sf /usr/local/etc/enshrouded/jobs/ctl /usr/local/bin/stop \
    && ln -sf /usr/local/etc/enshrouded/jobs/ctl /usr/local/bin/restart \
    && ln -sf /usr/local/etc/enshrouded/jobs/ctl /usr/local/bin/update \
    && ln -sf /usr/local/etc/enshrouded/jobs/ctl /usr/local/bin/backup \
    && ln -sf /usr/local/etc/enshrouded/jobs/ctl /usr/local/bin/backup-config \
    ...
    && ln -sf /usr/local/etc/enshrouded/jobs/ctl /usr/local/bin/cron-start \
    && ln -sf /usr/local/etc/enshrouded/jobs/ctl /usr/local/bin/cron-stop \
    && ln -sf /usr/local/etc/enshrouded/jobs/ctl /usr/local/bin/cron-restart
